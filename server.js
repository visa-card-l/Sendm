...
app.get('/subscription-success', (req, res) => {
  res.send(`
    ...
    <body>
      ...
      <p><a href="/" style="color:#ffd700;">â† Back to Dashboard</a></p>
    </body></html>
  `);
});
...
app.listen(PORT, () => {
  console.log('\nSENDEM SERVER â€” FULLY FIXED');
  console.log(`Server running on http://localhost:${PORT}`);
  console.log(`Admin panel: http://localhost:${PORT}/admin-limits`);
  console.log('Welcome message is now safely separated â€” blank page bug is gone!\n');
});
